...
public class ThreeKingdomsFortuneCOMEngineManagerTest {
	...
	private long[] noWinForce = { 1000000, // division 29
	...
	public void setUp() throws Exception {
		logger = Logger.getLogger(ThreeKingdomsFortuneCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ThreeKingdomsFortuneIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ThreeKingdomsFortuneIW/InitOutcome.xml").getDocumentElement();
